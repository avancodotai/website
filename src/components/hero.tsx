...
export function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center bg-neutral-950 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-8 pt-24 pb-16 lg:pt-28 lg:pb-20 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <motion.div variants={stagger} initial="initial" animate="animate">
            ...
            <motion.h1
              variants={fadeIn}
              className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-white leading-[0.95]"
            >
              Notes that
              <br />
            ...
            <motion.p
              variants={fadeIn}
              className="mt-5 text-base sm:text-lg text-neutral-400 max-w-md leading-relaxed"
            >
          ...
          >
            <div className="relative">
              {/* Glow behind card */}
              <div
                className="absolute -inset-2 bg-gradient-to-r from-orange-500/20 via-rose-500/20 to-orange-500/20 rounded-2xl blur-xl"
                aria-hidden="true"
              />
              ...
              <div className="relative bg-neutral-900 border border-white/10 rounded-2xl overflow-hidden">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2">
                  ...
                  <div className="p-5 border-b sm:border-b-0 sm:border-r border-white/5">
                    ...
                    <div className="font-mono text-[13px] text-neutral-500 leading-relaxed space-y-1">
